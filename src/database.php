...
DB;
    ...
    public static $listCheckedURLs = "SELECT S.url, status, success, label, graph, subject, predicate FROM url_statuses as S JOIN urls_found as U ON (S.url=U.url)";
...
class Database {
 ...
 print_r( $statement->errorinfo() );
    ...
    public function changeRunStateFromXtoY($old, $new) {
        ...
        $lastRun = $lastRunLockingStatement->fetch(PDO::FETCH_ASSOC);
